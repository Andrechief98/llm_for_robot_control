...
def generate_actor_positions(num_actors, world_size):
    ...
    for _ in range(num_actors):
        spawn_x = random.uniform(1.5, world_size-1)
        spawn_y = random.uniform(1.5, world_size-1)
        orient_z = random.uniform(0, 2*3.14)
        actors.append((spawn_x, spawn_y, orient_z))
    return actors

def create_gazebo_world_with_actors(actors, world_filename="/home/andrea/ros_packages_aggiuntivi/src/llm_generation_trajectory/world/dynamic_world_2obs.world"):
