...
def create_gazebo_world_with_actors(actors, world_filename="/home/andrea/ros_packages_aggiuntivi/src/llm_generation_trajectory/world/dynamic_world_6obs.world"):
