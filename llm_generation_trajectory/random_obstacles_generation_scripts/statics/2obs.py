...
def generate_obstacle_positions(num_obstacles, world_size, min_size, max_size):
    ...
    for _ in range(num_obstacles):
        while True:
            ...
            x = random.uniform(1.5, world_size)
...
def create_gazebo_world(obstacles, world_filename="/home/andrea/ros_packages_aggiuntivi/src/llm_generation_trajectory/world/static_world_2obs.world"):
