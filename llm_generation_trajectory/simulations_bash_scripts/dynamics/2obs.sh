...
for ((i=0; i<NUM_SIMULATIONS; i++)); do
  ...
  # Run the simulation
  gnome-terminal -- roslaunch llm_generation_trajectory dynamic_2obs.launch

  sleep 10

  cd /home/andrea/ros_packages_aggiuntivi/src/llm_generation_trajectory/bag_files/dynamic_obstacles/2_obs

  gnome-terminal -- rosbag record -O dynamic_obstacles_10.bag --duration=200 /gazebo/model_states /gazebo/bounding_boxes /gptGeneratedPath /callDuration /actor1/cmd_vel /actor2/cmd_vel
