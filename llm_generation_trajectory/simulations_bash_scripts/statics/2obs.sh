...
for ((i=0; i<NUM_SIMULATIONS; i++)); do
  ...
  # Run the simulation
  gnome-terminal -- roslaunch llm_generation_trajectory static_2obs.launch

  sleep 10
  
  cd /home/andrea/ros_packages_aggiuntivi/src/llm_generation_trajectory/bag_files/static_obstacles/2_obs
